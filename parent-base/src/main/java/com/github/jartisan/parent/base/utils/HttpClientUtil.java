package com.github.jartisan.parent.base.utils;
...
public class HttpClientUtil {
	...
	public static String httpGet(String url) {
		log.info("httpclient invoked,url:{}",url);
		...
		stpWatch.stop();
		log.info("httpclient invoked,耗时:{}ms",stpWatch.getTime(TimeUnit.MILLISECONDS));
		return body;
	}
	
	
	public static String httpGet(String url, List<NameValuePair> params) {
		log.info("httpclient invoked,url:{},params:{},",url,params);
		StopWatch stpWatch = new StopWatch();
		stpWatch.start();
		String body = null;
		CloseableHttpClient httpclient = null;
	...
	public static String httpPost(String url, Header[] headers, String outStr) {
		log.info("httpclient invoked,url:{},header:{},params:{},",url,headers,outStr);
		StopWatch stpWatch = new StopWatch();
		stpWatch.start();
		String body = null;
		CloseableHttpClient httpclient = null;
	...
	public static String httpPost(String url, String outStr) {
		log.info("httpclient invoked,url:{},params:{},",url,outStr);
		StopWatch stpWatch = new StopWatch();
		stpWatch.start();
		String body = null;
		CloseableHttpClient httpclient = null;
	...
	public static String httpPost(String url, List<NameValuePair> formparams) {
		log.info("httpclient invoked,url:{},params:{},",url,formparams);
		StopWatch stpWatch = new StopWatch();
		stpWatch.start();
		String body = null;
		CloseableHttpClient httpclient = null;
